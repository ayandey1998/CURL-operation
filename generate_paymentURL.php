...
$targetUrl      = 'https://uatpg.magma-hdi.co.in:444/MHDIWebIntegration/MotorProduct/api/TwoWheeler/GeneratePaymentURL';
$requestType    = 'POST';
$params         =  [ ];
$headers        = array
                    (
...
$postfields     = 
					'{
                            ...
                            "CustomerID": "20003428700",
                            "SuccessURL": "PartnerPaymentSuccessURL",
                            "FailureURL": "PartnerPaymentFailureURL",
                            "PartnerSource": "PartnerShortName",
                            "CustomerEmailID": "Nandkishor.Baviskar@magma-hdi.co.in",
                            "BillingAmount": "6649",
                            "CustomerMobileNumber": "8668675071",
                            "PaymentGateway":"IBANK"
                            }';
